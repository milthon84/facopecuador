      ...
      >
        ...
        <div className="absolute bottom-0 left-0 right-0 p-5 z-20 space-y-2">
          <div className="space-y-1">
            <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-amber-950/90 border border-amber-500/40 text-gold-400 text-[10px] font-bold tracking-wider uppercase backdrop-blur-md">
              <Sparkles size={11} />
